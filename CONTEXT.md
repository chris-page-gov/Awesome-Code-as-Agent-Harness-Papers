...
- Source-localization batches have fetched the survey PDF plus 17 unique arXiv
  paper PDFs, covering 18 paper fragments under [sources/raw/arxiv/](sources/raw/arxiv/).
  Fetch status and hashes
