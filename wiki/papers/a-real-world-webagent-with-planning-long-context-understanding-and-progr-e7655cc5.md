...
| --- | --- | --- | --- |
| Harness Mechanisms | Planning for Code Agents | Linear Decomposition Planning | ICLR 2024 |

## Localized Sources

- `sources/raw/arxiv/2307.12856.pdf` (local evidence cache; not committed by default)
