...
- Paper ID: `r1-code-interpreter-llms-reason-with-code-via-supervised-and-multi-stage-7b9d409d`
- Venue labels: arXiv 2025
- Source status: `integrated`
- Canonical URL:
  - [https://arxiv.org/abs/2505.21668](https://arxiv.org/abs/2505.21668)

## Survey Placement

| Layer | Section | Subsection | Venue |
| --- | --- | --- | --- |
| Harness Interface | Code for Reasoning | Iterative Code-Grounded Reasoning | arXiv 2025 |

## Localized Sources

- `sources/raw/arxiv/2505.21668.pdf` (local evidence cache; not committed by default)

### Local File Metadata

- path `sources/raw/arxiv/2505.21668.pdf`, 4194769 bytes, SHA-256 `dc6f0e9f1f70ea0477846cc521413b18422f34f5ab182081cdc338197e4be2d7`
