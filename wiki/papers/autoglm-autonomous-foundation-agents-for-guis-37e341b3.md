...
| --- | --- | --- | --- |
| Applications and Emerging Fields | GUI / OS Agents | Memory as Persistent Program State | arXiv 2024 |

## Localized Sources

- `sources/raw/arxiv/2411.00820.pdf` (local evidence cache; not committed by default)
