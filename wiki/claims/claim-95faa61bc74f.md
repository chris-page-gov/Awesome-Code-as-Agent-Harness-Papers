...
Executable Code Actions Elicit Better LLM Agents provides localized evidence about approval and human oversight for the Code as Agent Harness wiki.
...
- Source refs:
  - `sources/raw/openreview/8oJyuXfrPv.pdf`
- Locator: sources/raw/openreview/8oJyuXfrPv.pdf; extracted sentence match for approval
- Matched terms: `human`
