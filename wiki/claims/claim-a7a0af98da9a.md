...
GUI-Libra: Training Native GUI Agents to Reason and Act with Action-aware Supervision and Partially Verifiable RL provides localized evidence about gateway and routing for the Code as Agent Harness wiki.
...
- Locator: sources/raw/arxiv/2602.22190.pdf; extracted sentence match for gateway
- Matched terms: `proxy`
