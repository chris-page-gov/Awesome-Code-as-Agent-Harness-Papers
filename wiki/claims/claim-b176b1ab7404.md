...
Navigating the Digital World as Humans Do: Universal Visual Grounding for GUI Agents provides localized evidence about memory and state for the Code as Agent Harness wiki.

## Evidence

- Paper fragment:
  - [navigating-the-digital-world-as-humans-do-universal-visual-grounding-for-2b299bb2](../papers/navigating-the-digital-world-as-humans-do-universal-visual-grounding-for-2b299bb2.md)
- Source refs:
  - `sources/raw/openreview/kxnoqaisCT.pdf`
- Locator: sources/raw/openreview/kxnoqaisCT.pdf; extracted sentence match for memory
- Matched terms: `state`
