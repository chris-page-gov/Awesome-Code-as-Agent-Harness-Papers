...
- Paper ID: `on-generative-agents-in-recommendation-38830c5b`
- Venue labels: SIGIR 2024
- Source status: `integrated`
- Canonical URL:
  - [https://arxiv.org/abs/2310.10108](https://arxiv.org/abs/2310.10108)

## Survey Placement

| Layer | Section | Subsection | Venue |
| --- | --- | --- | --- |
| Applications and Emerging Fields | Agent Personalization | From Static Recommendation to Interactive Personalization | SIGIR 2024 |

## Localized Sources

- `sources/raw/arxiv/2310.10108.pdf` (local evidence cache; not committed by default)

### Local File Metadata

- path `sources/raw/arxiv/2310.10108.pdf`, 2311882 bytes, SHA-256 `d837c66b0f98665c7876e2cc260e86603bf42e35442f1b7a7a394f2a9ffbc4c5`
