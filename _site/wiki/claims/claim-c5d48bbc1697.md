...
Voyager: An Open-Ended Embodied Agent with Large Language Models provides localized evidence about memory and state for the Code as Agent Harness wiki.
...
- Locator: sources/raw/openreview/ehfRiF0R3a.pdf; extracted sentence match for memory
