...
- The OKFR publication/export work is tracked in
  ...
  Generated static publication output lives under [_site/](_site/), with a
  Pages workflow at [.github/workflows/pages.yml](.github/workflows/pages.yml).
  The target Pages URL is
  `https://chris-page-gov.github.io/Awesome-Code-as-Agent-Harness-Papers/`.
  JIT/spec screenshots live under [wiki/assets/okfr-jit/](wiki/assets/okfr-jit/).
...
- Use `tools/build_okfr_site.py` to regenerate `_site/`. The static viewer is
  a generated publication surface; reusable interactive OKFR behavior should be
  implemented in SeeLinks and kept pack-specific through data.
